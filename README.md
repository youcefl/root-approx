...
I wrote a [PARI/GP](https://pari.math.u-bordeaux.fr/) script which can generate this kind of approximations. It is based on the principles described in this page. To invoke the script, start by installing PARI/GP, run it and then call function approximate_nthroot(n, a, depth):
```
$ gp
gp > \r proximar.gp
